...
function AbstractMIAModel($q, $MIA, module) {
	...
	// public
		...
		// methods
			...
			this.add = function(data) {
				return $MIA.add(module, data).then(that.refresh);
			};

			this.edit = function(code, data) {
				return $MIA.edit(module, code, data).then(that.refresh);
			};

			this.delete = function(code) {
				return $MIA.delete(module, code).then(that.refresh);
			};
