	...
	// public
		...
		this.searchOne = function(module, code) {
			...
			return $q(function(resolve, reject) {
				...
				$http.get("/api/" + module.toLowerCase() + "/" + code, { headers : headers }).then(function(res) {
		...
		this.add = function(module, params) {
			...
			return $q(function(resolve, reject) {
				...
				$http.put("/api/" + module.toLowerCase(), params, { headers : headers }).then(function(res) {
		...
		this.delete = function(module, code) {
			...
			return $q(function(resolve, reject) {
				...
				reject("'delete' en cours de création");
