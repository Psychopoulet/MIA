        ...
        function _setStatus(title, status, device) {
            ...
            $MIA.searchOne("status", status).then(function(status) {
                ...
                if (!status) {
                    ...
                    $MIA.edit("devices", _device.token, _device).then(_getDevices).catch(function(err) {
            ...
            $scope.rename = function (device) {
                ...
                $popup.prompt({
                    ...
                    onconfirm: function(name) {
                        ...
                        $MIA.edit("/api/devices/" + _device.token, _device).then(_getDevices).catch(function(err) {
