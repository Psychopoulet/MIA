	...
	container.set(
		...
		container.get("servers.app").get("/api/plugins", (req, res) => {
			...
			if ("object" !== typeof req.params) {
				container.get("servers.web").sendWrongRequestJSONResponse(res, [ { code: "plugins-searchone-020", message: "Il manque les données de plugin" } ]);
			}
				else if ("string" !== typeof req.params.name) {
					container.get("servers.web").sendWrongRequestJSONResponse(res, [ { code: "plugins-searchone-021", message: "Il manque le nom" } ]);
				}
			else {
				...
				container.get("servers.web").sendValidJSONResponse(res, result);
			...
			if ("object" !== typeof req.params) {
				container.get("servers.web").sendWrongRequestJSONResponse(res, [ { code: "plugins-update-020", message: "Il manque les données de plugin" } ]);
			}
				else if ("string" !== typeof req.params.name) {
					container.get("servers.web").sendWrongRequestJSONResponse(res, [ { code: "plugins-update-021", message: "Il manque le nom" } ]);
				}
			else {
				...
				if (!result) {
					container.get("servers.web").sendWrongRequestJSONResponse(res, [ { code: "plugins-update-030", message: "Ce plugin n'existe pas" } ]);
				}
				else {
			...
			if ("object" !== typeof req.params) {
				container.get("servers.web").sendWrongRequestJSONResponse(res, [ { code: "plugins-delete-020", message: "Il manque les données de plugin" } ]);
			}
				else if ("string" !== typeof req.params.name) {
					container.get("servers.web").sendWrongRequestJSONResponse(res, [ { code: "plugins-delete-021", message: "Il manque le nom" } ]);
				}
			else {
				...
				if (!result) {
					container.get("servers.web").sendWrongRequestJSONResponse(res, [ { code: "plugins-delete-30", message: "Ce plugin n'existe pas" } ]);
				}
				else {

					container.get("plugins").uninstall(result).then((plugin) => {
