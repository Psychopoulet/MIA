...
module.exports = (container) => {
	...
	require(path.join(__dirname, "mia", "controllers.js"))(container);
	require(path.join(__dirname, "mia", "controllerstypes.js"))(container);
	require(path.join(__dirname, "mia", "controllersfunctions.js"))(container);
