		...
		sendResponse(res, code, contentType, msg) {
			...
			sendHTMLResponse(res, code, msg) {
				...
				sendNotFoundHTMLResponse(req, res) {
					this.sendHTMLResponse(res, 404, "404 : [" + req.method + "] \"" + req.url + "\" not found");
				}
			...
			sendJSONResponse(res, code, msg) {
				...
				sendErrorJSONResponse(res, code, msg) {
					...
					sendNotFoundJSONResponse(req, res) {
						this.sendErrorJSONResponse(res, 404, [ { code: "notfound", message: "404 : [" + req.method + "] \"" + req.url + "\" not found" } ]);
					}
