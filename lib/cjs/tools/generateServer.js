...
function generateServer(container) {
    return new Promise((resolve) => {
        ...
        app.get(["/", "/public/index.html"], (req, res, next) => {
            const file = (0, node_path_1.join)(__dirname, "..", "..", "..", "public", "index.html");
        ...
        // pictures
        app.get(["favicon.ico", "/favicon.ico", "/public/pictures/favicon.ico"], (req, res) => {
            return res.sendFile((0, node_path_1.join)(__dirname, "..", "..", "..", "public", "pictures", "favicon.ico"));
        }).get(["favicon.png", "/favicon.png", "/public/pictures/favicon.png"], (req, res) => {
            return res.sendFile((0, node_path_1.join)(__dirname, "..", "..", "..", "public", "pictures", "favicon.png"));
        });
        ...
        app.use((req, res, next) => {
            ...
            if (res.headersSent) {
                return next((0, getRequestPath_1.default)(container, req) + " not found");
            }
            else {
                res.status(404).json({
                    "code": 404,
