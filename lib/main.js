...
// private
	...
	function _loadDatabase(Container) {
		...
		return require("node-scenarios").init(path.join(__dirname, "..", "database", "MIA.sqlite3")).then((scenariosContainer) => {

			scenariosContainer.forEach((value, key) => {
				Container.set(key, value);
			});

			Container	.set("childs", new (require(path.join(__dirname, "..", "database", "childs.js")))(Container))
						.set("clients", new (require(path.join(__dirname, "..", "database", "clients.js")))(Container))
						.set("crons", new (require(path.join(__dirname, "..", "database", "crons.js")))(Container))
						.set("status", new (require(path.join(__dirname, "..", "database", "status.js")))(Container))
						.set("users", new (require(path.join(__dirname, "..", "database", "users.js")))(Container));
			...
			if (MIADatabaseCreated) {
				...
				return new Promise((resolve, reject) => {
					...
					Container.get("db").execFileTrans(path.join(__dirname, "..", "database", "create.sql"), (err) => {
