...
CREATE TABLE IF NOT EXISTS crons_actions (
	id_cron INTEGER,
	id_action INTEGER,
	PRIMARY KEY(id_cron, id_action),
...
CREATE TABLE IF NOT EXISTS crons_scenario (
	id_cron INTEGER,
	id_scenario INTEGER,
	PRIMARY KEY(id_cron, id_scenario),
	FOREIGN KEY(id_cron) REFERENCES crons(id) ON DELETE CASCADE ON UPDATE CASCADE,
	FOREIGN KEY(id_scenario) REFERENCES actions(id) ON DELETE CASCADE ON UPDATE CASCADE
);
